...
struct NudgeReminderView: View {
            ...
            VStack(spacing: 0) {
                ScrollView {
                    VStack(alignment: .leading, spacing: DesignSystem.Spacing.large) {
                        ...
                        Text("Selecting \"Nudge everyone\" will send a push notification to all participants in this Table.")
                            .font(.footnote)
    ...
    private func confirmReminder() async {
        ...
        do {
            // Update table data
            table.nextReminderDate = selectedDate
...
#Preview {
    NudgeReminderView(table: TableModel(title: "Career crossroads", members: ["Sarah", "Marcus"]))
